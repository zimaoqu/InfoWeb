...
<div class="container-fluid">
    ...
    <div class="col-md-7" id="graph" style="position:relative">
        <div class="row-fluid div_overflow text-center">
            <div class="btn-group">
                <a class="btn btn-default" href="${pageContext.request.contextPath}/zmq/showCompanyRelationship_last_month">近一月</a>
                <a class="btn btn-default" href="${pageContext.request.contextPath}/zmq/showCompanyRelationship_last_season">近一季</a>
                <a class="btn btn-default" href="${pageContext.request.contextPath}/zmq/showCompanyRelationship_last_half_year">近半年</a>
    ...
    <%
        ...
        try {
            ...
            File file = new File("C://dict//real_data//season(50).txt");
