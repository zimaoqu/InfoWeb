...
<div class="menu">
    <table >
        ...
        <TR>
            <TD>
                <TABLE id=table_2 style="DISPLAY: block" cellSpacing=0 cellPadding=2 width=200 align=center border=0>
                    <TBODY>
                    <TR>
...
<div class="echart_container">
    <div id="l1" style="display: block">
        <div id="graphiccopper" class="echart_container3" ></div>

    </div>
</div>
<script src="${pageContext.request.contextPath}/resources/js/zmqjs/KeyIndicatescopper.js" type="text/javascript"></script>
</body>
</html>
