...
<div class="echart_container">
    <div id="l1" style="display: block">
        <div id="graphicCrude" class="echart_container3" ></div>

    </div>
</div>
<script src="${pageContext.request.contextPath}/resources/js/zmqjs/KeyIndicatesCrude.js" type="text/javascript"></script>
</body>
</html>
