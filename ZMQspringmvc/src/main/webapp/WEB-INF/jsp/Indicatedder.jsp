...
<div class="echart_container">
    <div id="l1" style="display: block">
        <div id="graphicdder" class="echart_container3" ></div>
...
<script src="${pageContext.request.contextPath}/resources/js/zmqjs/KeyIndicatedder.js" type="text/javascript"></script>
</body>
</html>
